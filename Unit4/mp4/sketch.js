...
function setup() {
  ...
  snow = loadImage("snow1.png");
  snow2 = loadImage("snow2.png");
  olaf = loadImage("olaf.png");
  f1 = loadFont("funnystudy.ttf");
  //frozen = loadImage("frozen.jpg");
  glitter = loadImage("glitter.jpg");
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
...
function draw() {
  ...
  image(glitter, width/2, height/2, width, height); // light blue
  ...
  textAlign(CENTER);
  textFont(f1);
  text("Do you wanna build a snowman?", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(snow2, this.pos.x, this.pos.y, 50, 50);
